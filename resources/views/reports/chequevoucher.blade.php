...
<body>
  ...
  <div class="cheque-labels cheque-amount-words">** {{ $amount_in_words }} Pesos Only ** </div>
    ...
    <tr>
      <td class="w-50 pr-3" valign="top">
        <table class="w-100 bordered table-border-collapse">
          ...
          @for ($i = 0; $i < 20; $i++) @if ($i <=count($disbursement->disbursementDetails) -1)
            <tr>
      ...
      <td class="w-50 pl-3" valign="top">
        <table class="w-100 bordered table-border-collapse">
          ...
          @for ($i = 0; $i < 19; $i++) @if ($i <=count($disbursement->summedAccountTitles) -1)
            <tr>
