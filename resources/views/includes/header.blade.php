  ...
  <table class="report__header w-100">
    <tr>
      ...
      <td class="w-25 text-center" rowspan="4" style="vertical-align: middle;">
        @php
        $logo = $company_setting->logo ? $company_setting->logo->path : ''
        @endphp
        <img class="logo" src="{{url('storage/'.$logo)}}" alt="">
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td class=" company__sub-title">Contact Numbers: {{ $company_setting->contact_no }}
      </td>
    </tr>
    <tr>
